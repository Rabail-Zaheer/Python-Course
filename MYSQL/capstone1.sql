...
--Join Customer and Salesman using Salesman_id.
-- This should return each customer with the salesman assigned to them.
...
-- Step 5:
-- Join Orders, Customer, and Salesman.
-- Run WHERE Customer.city <> Salesman.city.
-- This should return orders where the customer and the salesman
...
-- Step 6:
-- Join Orders and Customer using customer_id.
-- This should return every order together with the customer's name.
...
-- Step 7:
-- Join all three tables and run WHERE Customer.grade IS NOT NULL.
-- This should return only the customers who have a grade.
-- Customers with an empty or missing grade will not be shown.
